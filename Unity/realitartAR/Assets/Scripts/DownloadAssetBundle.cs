...
public class DownloadAssetBundle : MonoBehaviour
{
    ...
    public IEnumerator DownloadAssetBundleFromServer(String assetData)
    {
        ...
        using (UnityWebRequest www = UnityWebRequestAssetBundle.GetAssetBundle(url))
        {
            ...
            {
                Debug.Log(www.error);
                GetComponent<UnityMessageManager>().SendMessageToFlutter("Unity error: " + www.error);
            }
            else
            {
    ...
    private void InstantiateGameObjectFromAssetBundle(GameObject go, String scale, String position, String rotation)
    {
        ...
        else
        {
            ...
            GetComponent<UnityMessageManager>().SendMessageToFlutter("Unity error: your asset bundle go is null");
